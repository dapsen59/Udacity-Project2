...
----
    ...
    /opt/conda/lib/python3.6/site-packages/cassandra/cluster.cpython-36m-x86_64-linux-gnu.so in cassandra.cluster.Session._get_execution_profile (cassandra/cluster.c:40927)()
    ...
    <ipython-input-17-ef666625cf49> in <module>()
    ...
    ---> 17         session.execute(query,  line[0], line[9], float(line[5]), int(line[8]), int(line[3]) 
         18     )


    /opt/conda/lib/python3.6/site-packages/cassandra/cluster.cpython-36m-x86_64-linux-gnu.so in cassandra.cluster.Session.execute (cassandra/cluster.c:38517)()


    /opt/conda/lib/python3.6/site-packages/cassandra/cluster.cpython-36m-x86_64-linux-gnu.so in cassandra.cluster.Session.execute_async (cassandra/cluster.c:38827)()


    /opt/conda/lib/python3.6/site-packages/cassandra/cluster.cpython-36m-x86_64-linux-gnu.so in cassandra.cluster.Session._create_response_future (cassandra/cluster.c:39602)()


    /opt/conda/lib/python3.6/site-packages/cassandra/cluster.cpython-36m-x86_64-linux-gnu.so in cassandra.cluster.Session._get_execution_profile (cassandra/cluster.c:41012)()


    ValueError: Invalid execution_profile: '1'; valid profiles are dict_keys([<object object at 0x7f72f8496260>])
